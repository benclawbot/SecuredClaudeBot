...
// Context type removed - using unknown for telegramCtx
...
import { userPreferences } from '../providers/preferences.js';
...
export async function sendToAgent(
  ...
  try {
    ...
    // MCP tools are optional - only create if context provides needed functionality
    // For now, we skip MCP server creation in the gateway
